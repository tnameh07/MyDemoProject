...
public class Admin {
    ...
    void AddDoctors(Scanner sc) {
        ...
        try {
            String SqlQuary = "INSERT INTO doctors(Doctorsname, Specialist ,City,State,Contact_number ,Appointment_charge,Password) VALUES ( ?,?,?,?,?,?,?)";
            // Address,
            ...
            if (result > 0) {
                ...
                String createuser = "SELECT * FROM doctors WHERE Doctorsname =? AND Password =? AND Contact_number =? AND Specialist =?";
    ...
    void viewPateintslist(Scanner sc) {
        try {
            boolean check = false;
            String Viewpatients = "SELECT * FROM patients2";
