...
final class Patients {
    ...
    void SignUp(Scanner sc) {
        ...
        try {
            String SqlQuary = "INSERT INTO patients2(Name, Age ,Address, Contact_Details ,pswd) VALUES ( ?,?,?,?,?)";
            ...
            if (result > 0) {
                ...
                String createuser = "SELECT * FROM patients2 WHERE Contact_Details =? AND Name =? AND pswd =?";
    ...
    void Login(Scanner sc) {
        ...
        while (ch >= 1) {
            try {
                ...
                String SqlQuary = "SELECT * FROM patients2 WHERE PatientId =? AND pswd =?";
                ...
                while (vp) {
                    try {
                        ...
                        if (ch == 'y' || ch == 'Y') {
                            ...
                            switch (option) {
                                case 1:
                                    String pswd = "UPDATE patients2 SET pswd =? WHERE PatientId = ?";
                                    ...
                                    break;
                                case 2:
                                    String add = "UPDATE patients2 SET Address =? WHERE PatientId = ?";
                                    ...
                                    break;
                                case 3:
                                    String contact = "UPDATE patients2 SET Contact_Details =? WHERE PatientId = ?";
                                    ...
                                    break;
                                case 4:
                                    String changename = "UPDATE patients2 SET Name =? WHERE PatientId = ?";
    ...
    void PayOnline(Scanner sc) throws SQLException {
        ...
        while (po) {
            ...
            System.out.println("Appointment date in Formate of yyyy-mm-dd");
            appointment_date = sc.nextLine();
            String ps = "SELECT * FROM PatientsReport WHERE PatientId =? AND DoctorId =? AND Appointment_Date=?";
            try {
